...
public class Person
{
   ...
   public static class PersonBuilder
	...
	public String toString() {
		return "PersonBuilder [nestedLastName=" + nestedLastName + ", nestedFirstName=" + nestedFirstName
				+ ", nestedMiddleName=" + nestedMiddleName + ", nestedSalutation=" + nestedSalutation
				+ ", nestedSuffix=" + nestedSuffix + ", nestedStreetAddress=" + nestedStreetAddress + ", nestedCity="
				+ nestedCity + ", nestedState=" + nestedState + ", nestedIsFemale=" + nestedIsFemale
				+ ", nestedIsEmployed=" + nestedIsEmployed + ", nestedIsHomeOwner=" + nestedIsHomeOwner + "]";
	}
   }
   public Person(
